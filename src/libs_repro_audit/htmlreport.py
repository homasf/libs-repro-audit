...
<footer>
<p>Generated by <strong>libs-repro-audit</strong>, the machine-actionable
record accompanying Saeidfirozeh &amp; Ferus, <em>A reproducibility-audit
framework for calibration-free LIBS/LIPS quantification</em>. Anyone can
regenerate this report from the same audit record:
<code>libs-audit record.json -o report.html</code></p>
</footer>
</div>
</body>
</html>
